...
public abstract class AnnotationInjectedBeanPostProcessor extends
    ...
    private final HashMap<Class<?>, Object> injectedObjectsCacheMock = new HashMap<>(CACHE_SIZE);
    ...
    public class AnnotatedFieldElement extends InjectionMetadata.InjectedElement {
        ...
        protected void inject(Object bean, String beanName, PropertyValues pvs) throws Throwable {
            ...
            //Object injectedObject = getInjectedObject(attributes, bean, beanName, injectedType, this);
            if (injectedObjectsCacheMock.get(injectedType) == null) {
                Object mock = Mockito.mock(injectedType);
                injectedObjectsCacheMock.put(injectedType, mock);
            }
            Object objectMock = injectedObjectsCacheMock.get(injectedType);
            ReflectionUtils.makeAccessible(field);

            field.set(bean, objectMock);
